    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='생성일')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='수정일')),
                ('job_description', models.ForeignKey(db_comment='해당 지원이력을 가지고 있는 채용공고입니다.', on_delete=django.db.models.deletion.CASCADE, to='job_description.jobdescription')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(db_comment='해당 지원이력을 가지고 있는 유저 입니다.', on_delete=django.db.models.deletion.CASCADE, to='job_description.user'),
        ),
        migrations.AddConstraint(
            model_name='resumehistory',
            constraint=models.UniqueConstraint(fields=('job_description', 'user'), name='unique_in_application'),
        ),
    ]
